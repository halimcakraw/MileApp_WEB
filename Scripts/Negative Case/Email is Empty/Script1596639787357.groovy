...
WebUI.sendKeys(findTestObject('Text_Btn/Email_txt'), Keys.chord(Keys.CONTROL, 'a'))
WebUI.sendKeys(findTestObject('Text_Btn/Email_txt'), Keys.chord(Keys.BACK_SPACE))
def Verify_1 = WebUI.getText(findTestObject('Verify/VerifEmail_Error'))
WebUI.verifyMatch(Verify_1, 'The email field is required.', true)
...
WebUI.verifyMatch(Verify_2, 'The email field is required.', true)
