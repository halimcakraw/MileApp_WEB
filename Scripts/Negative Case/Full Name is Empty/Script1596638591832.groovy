...
WebUI.sendKeys(findTestObject('Text_Btn/Name_txt'), Keys.chord(Keys.CONTROL, 'a'))
WebUI.sendKeys(findTestObject('Text_Btn/Name_txt'), Keys.chord(Keys.BACK_SPACE))
def Verify_1 = WebUI.getText(findTestObject('Verify/VerifName_Error'))
WebUI.verifyMatch(Verify_1, 'The name field is required.', true)
...
WebUI.verifyMatch(Verify_2, 'The full name field is required.', true)
