...
WebUI.sendKeys(findTestObject('Text_Btn/Phone_txt'), Keys.chord(Keys.CONTROL, 'a'))
WebUI.sendKeys(findTestObject('Text_Btn/Phone_txt'), Keys.chord(Keys.BACK_SPACE))
def Verify_1 = WebUI.getText(findTestObject('Verify/VerifPhone_Error'))
WebUI.verifyMatch(Verify_1, 'The phone field is required.', true)
...
WebUI.verifyMatch(Verify_2, 'The phone field is required.', true)
