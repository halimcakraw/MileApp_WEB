...
WebUI.sendKeys(findTestObject('Text_Btn/Organization_txt'), Keys.chord(Keys.CONTROL, 'a'))
WebUI.sendKeys(findTestObject('Text_Btn/Organization_txt'), Keys.chord(Keys.BACK_SPACE))
def Verify_1 = WebUI.getText(findTestObject('Verify/VerifOrganization_Error'))
WebUI.verifyMatch(Verify_1, 'The organization_name field is required.', true)

WebUI.click(findTestObject('Text_Btn/RequestDemo_btn'))

def Verify_2 = WebUI.getText(findTestObject('Verify/VerifNotif_Error'))
WebUI.verifyMatch(Verify_2, 'The organization name field is required.', true)
